    ...
    <div class="card-body">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$template->title}}" name="title" id="" class="form-control" required placeholder="Template title">
                    </div>
                    <div class="form-group">
                        ...
                        <img id="pimage" src="{{my_asset($template->preview)}}"  class="kyc-image mt-2"/>
                    </div>
                </div>
                <div class="col-md-6">
                    <div>
            ...
            <div class="form-group">
                ...
                <textarea name="html" id="summernote" class="form-control" cols="30" rows="10">{!! $template->html !!}</textarea>
            </div>

            <div class="form-group">
                <button class="btn-success btn w-100">Update Template</button>
            </div>
        </form>
    </div>
</div>
