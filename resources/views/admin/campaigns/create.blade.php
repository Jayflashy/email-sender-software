    ...
    <div class="card">
        <div class="card-header">
            <ul class="nav nav-tabs  nav-pills" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link disabled" data-bs-toggle="tab" href="#template" role="tab">Template</a>
                </li>
                <li class="nav-item">
        ...
        <form class="row" action="{{route('admin.campaigns.store')}}" method="post">
            @csrf
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{old('name')}}" class="form-control" id="name" placeholder="Campaign Name" required>
                        </div>
                        <div class="form-group">
                            <label for="">Email Subject</label>
                            <input type="text" name="subject" value="{{old('subject')}}" class="form-control" id="subject" placeholder="Email Subject" required>
                        </div>
                        <div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="domain_id" id="domainSelect" class="form-select">
                                ...
                                @foreach ($domains as $key => $item)
                                    <option data-reply="{{$item->reply_to}}" data-email="{{$item->email}}" data-name="{{$item->from_name}}" value="{{$item->id}}">{{$item->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="">From Name</label>
                            <input type="text" name="from_name" value="{{old('from_name')}}" class="form-control" id="fromName" placeholder="Mail From Name" required>
                        </div>
                        <div class="form-group">
                            <label for="">Sender Email Address</label>
                            <input type="email" name="email" value="{{old('email')}}" class="form-control" id="senderEmail" placeholder="Sender Email" required>
                        </div>
                        <div class="form-group">
                            <label for="">Reply To Email</label>
                            <input type="email" name="reply_to" value="{{old('reply_to')}}" class="form-control" id="replyTo" placeholder="Reply To Email" required>
                        </div>
                    </div>
                </div>
            </div>
