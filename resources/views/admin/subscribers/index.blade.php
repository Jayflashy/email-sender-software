...
<div class="modal fade" id="createGroup" tabindex="0" role="dialog">
    <div class="modal-dialog modal-dialog-centered" id="modal-size" role="document">
        <div class="modal-content position-relative">
            ...
            <div class="modal-body">
                <form action="{{route('admin.subscriber.create')}}" method="post">
                    @csrf
                    ...
                    <button class="btn btn-success w-100" type="submit">Add Subscriber</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            ...
            <a href="#" data-bs-target="#createGroup" data-bs-toggle="modal" class="btn btn-sm btn-primary">Add Subscriber</a>
        </div>
        <div class="card-body table-responsive">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="div">
                                    ...
                                    <a href="{{route('admin.subscriber.del',$item->id)}}" title="Delete" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> </a>
                                </div>
                            </td>
                        </tr>
            ...
            <div class="text-center">
                ...
                <a href="#" class="btn btn-lg btn-primary">Add Subscriber</a>
            </div>
            @endif
